...
class MainWindow(QMainWindow):
    ...
    # constructor
    def __init__(self, search: str = None, *args, **kwargs):
        ...
        # creating first tab
        if search is None:
            self.add_new_tab(QUrl(f"https://www.google.com"), 'Home Page')
        else:
            search = search.replace(" ", "+")
            self.add_new_tab(QUrl(f"https://www.google.com/search?q={search}"), 'Search Results')
